...
public class IndexUtils {
  ...
  public static IndexFileScan BTree_scan(CondExpr[] selects, IndexFile indFile) 
	...
	/**
     * BM_scan opens a Bitmap scan based on selection conditions (mirrors BTree_scan above)
     * @param selects conditions to apply
     * @param indFile the index (BTree) file
     * @return an instance of IndexFileScan (BTreeFileScan)
     * @exception IOException from lower layer
     ...
     * @exception ConstructPageException failed to construct a header page
     */
	public static IndexFileScan BM_scan(CondExpr[] selects, IndexFile indFile) 
		throws IOException, UnknownKeyTypeException, InvalidSelectionException,
			KeyNotMatchException,UnpinPageException, PinPageException,
			IteratorException, ConstructPageException
    {
		IndexFileScan indScan;
		  
		if (selects == null || selects[0] == null)
		{
			indScan = ((BitMapFile)indFile).new_scan(null, null);
			return indScan;
		}
		...
		if (selects[1] == null)
		{
			...
			if (selects[0].op.attrOperator == AttrOperator.aopEQ)
			{
				...
				{
					key = getValue(selects[0], selects[0].type1, 1);
					indScan = ((BitMapFile)indFile).new_scan(key, key);
				}
				else
				{
					key = getValue(selects[0], selects[0].type2, 2);
			...
			if (selects[0].op.attrOperator == AttrOperator.aopLT || selects[0].op.attrOperator == AttrOperator.aopLE)
			{
				...
				{
					key = getValue(selects[0], selects[0].type1, 1);
					indScan = ((BitMapFile)indFile).new_scan(null, key);
				}
				else
				{
					key = getValue(selects[0], selects[0].type2, 2);
			...
			if (selects[0].op.attrOperator == AttrOperator.aopGT || selects[0].op.attrOperator == AttrOperator.aopGE)
			{
				...
				{
					key = getValue(selects[0], selects[0].type1, 1);
					indScan = ((BitMapFile)indFile).new_scan(key, null);
				}
				else
				{
					key = getValue(selects[0], selects[0].type2, 2);
			...
			// error if reached here
			System.err.println("Error -- in IndexUtils.BM_scan()");
			return null;
		}
		else
		{
			...
			switch (type.attrType)
			{
				case AttrType.attrString:
					if (((StringKey)key1).getKey().compareTo(((StringKey)key2).getKey()) < 0)
					{
						indScan = ((BitMapFile)indFile).new_scan(key1, key2);
					}
					else
					{
						indScan = ((BitMapFile)indFile).new_scan(key2, key1);
					}
					return indScan;
	...
	public static IndexFileScan CBM_scan(CondExpr[] selects, IndexFile indFile) 
		throws IOException, UnknownKeyTypeException, InvalidSelectionException,
			KeyNotMatchException,UnpinPageException, PinPageException,
			IteratorException, ConstructPageException
    {
		...
		if (selects == null || selects[0] == null)
		{
			indScan = ((CBitMapFile)indFile).new_scan(null, null);
			return indScan;
		}
		...
		if (selects[1] == null)
		{
			...
			if (selects[0].op.attrOperator == AttrOperator.aopEQ)
			{
				...
				{
					key = getValue(selects[0], selects[0].type1, 1);
					indScan = ((CBitMapFile)indFile).new_scan(key, key);
				}
				else
				{
					key = getValue(selects[0], selects[0].type2, 2);
			...
			if (selects[0].op.attrOperator == AttrOperator.aopLT || selects[0].op.attrOperator == AttrOperator.aopLE)
			{
				...
				{
					key = getValue(selects[0], selects[0].type1, 1);
					indScan = ((CBitMapFile)indFile).new_scan(null, key);
				}
				else
				{
					key = getValue(selects[0], selects[0].type2, 2);
			...
			if (selects[0].op.attrOperator == AttrOperator.aopGT || selects[0].op.attrOperator == AttrOperator.aopGE)
			{
				...
				{
					key = getValue(selects[0], selects[0].type1, 1);
					indScan = ((CBitMapFile)indFile).new_scan(key, null);
				}
				else
				{
					key = getValue(selects[0], selects[0].type2, 2);
		...
		else
		{
			...
			switch (type.attrType)
			{
				case AttrType.attrString:
					if (((StringKey)key1).getKey().compareTo(((StringKey)key2).getKey()) < 0)
					{
						indScan = ((CBitMapFile)indFile).new_scan(key1, key2);
					}
					else
					{
						indScan = ((CBitMapFile)indFile).new_scan(key2, key1);
					}
					return indScan;
