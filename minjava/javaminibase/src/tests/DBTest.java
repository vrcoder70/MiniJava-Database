...
class DBDriver extends TestDriver implements GlobalConst {
  ...
  //print read write stats for particular test
  protected void printReadWriteStats()
  {
	  System.out.print("  Read Count: " + PCounter.getReadCount() + "\n");
	  System.out.print("  Write Count: " + PCounter.getWriteCount() + "\n");
  }
